// src/shared/lib/supabase.js - Supabase Cloud Sync
...
const _SB_SERVICE_KEY = _cfgSafeKey(_cfgRaw.sbServiceKey) || null;
const _SB_HEADERS = {
  apikey: _SB_KEY,
...
const _setSyncStatusCallback = (cb) => { _syncStatusCallback = cb; };
const _getSyncStatusCallback = () => _syncStatusCallback;
...
export {
  ...
  _validateMimeType,
  _sbStorageUpload,
  _sbStorageGetSignedUrl,
  _sbStorageDelete,
  _setSyncStatusCallback,
  _getSyncStatusCallback,
  _sync,
  _patKey,
  _patKeyCloud,
  _compKey,
