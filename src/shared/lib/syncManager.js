...
// FIX 2026-08-07: se retiraron _d1Config/_d1GetAll/_d1Get — leían
// window.__SISO_CONFIG?.workerToken y lo mandaban como header X-Siso-Token
// en un fetch hecho DESDE EL NAVEGADOR contra el Worker siso-api. Vector de
// fuga del token maestro (acceso global de lectura/escritura a toda la D1
// compartida, sin scopes por usuario). Estaba inerte porque nada en el
// refactor puebla window.__SISO_CONFIG hoy, pero quedaba listo para filtrar
// el token en cuanto alguien conectara esa pieza. Ver siso-appultimo/CLAUDE.md
// ("Segundo precedente") y docs/audits/REFRACTOR_D1_BFF_SECURITY_DESIGN.md
// para el patrón correcto (BFF same-origin, token solo server-side) — no
// implementado aquí, queda para una fase futura explícitamente autorizada.
