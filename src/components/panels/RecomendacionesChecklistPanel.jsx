...
// Corregido: encoding UTF-8, props alineadas (selected/onChange/onGenerate)
import React, { useState } from 'react';
import { RECOMENDACIONES_CATALOG } from '../../shared/data/recomendaciones.js';
import { CheckSquare, Square, X, Sparkles, ClipboardList, Loader2, ChevronRight } from 'lucide-react';

const RecomendacionesChecklistPanel = ({ selected, onChange, onClose, onApply, isGenerating, onGenerate }) => {
