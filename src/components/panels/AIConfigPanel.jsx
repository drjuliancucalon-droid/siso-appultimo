...
const AIConfigPanel = ({ aiConfig, onSave, onClose }) => {
  ...
  const PROVIDER_INFO = {
    gemini: {
      ...
      color: "blue",
      steps: [
        "1?? Haz clic en el botón 'Obtener key ?' de abajo",
        "2?? Inicia sesión con tu cuenta de Google (Gmail)",
        "3?? Aparecerá el panel de 'API Keys'. Clic en 'Create API Key'",
        "4?? Selecciona 'Create API key in new project' (es gratis)",
        "5?? Se genera una key que empieza con 'AIza...' ? cópiala",
        "6?? Regresa aquí, pégala en el campo y presiona 'Probar'",
    ...
    groq: {
      ...
      steps: [
        "1?? Haz clic en el botón 'Obtener key ?' de abajo",
        "2?? Crea cuenta gratis con Google o GitHub (botón 'Sign Up')",
        "3?? Una vez dentro, ya estarás en la sección 'API Keys'",
    ...
    together: {
      ...
      steps: [
        ...
        "3?? En el panel, ve a Settings ? API Keys (menú izquierdo)",
    ...
    openrouter: {
      ...
      steps: [
        ...
        "3?? En el menú superior, clic en 'Keys'",
