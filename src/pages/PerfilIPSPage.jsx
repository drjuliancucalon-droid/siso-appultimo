...
import { _sbSet, _compKey, _compKeyCloud } from '../shared/lib/supabase.js';
import { _safeLogoUrl } from '../shared/lib/crypto.js';

const PerfilIPSPage = ({
  goBack, showAlert, currentUser,
