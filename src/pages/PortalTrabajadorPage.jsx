...
const PortalTrabajadorPage = ({
  portalCodigo, setPortalCodigo,
  portalMultiple, setPortalMultiple,
  portalPaciente, setPortalPaciente,
  patientsList, showAlert, goBack, renderNavbar,
  currentUser, companies, _generarCertificadoHTMLNormalizado,
