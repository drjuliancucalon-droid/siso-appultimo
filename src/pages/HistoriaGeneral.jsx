...
const HistoriaGeneral = (props) => {
  const {
    ...
    SectionTitle, SelectGroup, TextAreaGroup, CIE10Input,
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  {/* Impresión: antecedente negativo → mostrar "Niega" en texto */}
                  {!hasContent && (
                  ...
                  <div style={{ flex: "0 0 auto", width: "340px" }}>
                    <CIE10Input
                      ...
                      onChange={(v) => {
                        ...
                        // Detectar si seleccionó un item completo "CÓDIGO - descripción"
                        const match = v.match(
                          /^([A-Z][0-9]{2}[\.0-9]*)\s+-\s+(.+)$/
                        );
                        if (match) {
