...
const Navbar = () => {
  const {
    ...
    aiStatus, setShowAIConfig,
    syncStatus,
    activeTab, setActiveTab, data, dataType,
    agendados, mensajes,
    handleCloseHistory, handleEditHistory, handlePrint,
    goTo, goBack,
    ...
    BrandLogo,
    _ls,
    showSyncReport, setShowSyncReport, syncReport,
    showAlert, setAuditLog, patientsList, handleSavePatient,
    setRipsModalData, setShowMensajePanel, usersList,
